...
![System Tech Stack Flow](docs/images/system-tech-stack-flow.png)

| Domain | Stack | Focus |
|------|------|------|
| Backend | NodeJS · Express | API, Auth, Service Backbone |
| AI / ML | PyTorch · FastAPI | Training, Inference, Model Serving |
| Frontend | React · Three.js | UI, 3D Visualization |
